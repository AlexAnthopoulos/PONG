...
class PongScene
{
    ...
    create ()
    {
        ...
        this.p1VictoryText = this.add.text(centerX, centerY, 'Player 1 Wins!');
    ...
    update (timestamp, dt)
    {
        ...
        if(this.players[0].score === 7  ){
            ...
            this.scene.launch('ModalText', ModalText, true, { x:400, y: 300 });
            this.scene.pause();
...
class ModalText extends Phaser.Scene {
    ...
    create (data)
    {
        ...
        const centerX = 0.5 * width;
        const centerY = 0.5 * height;
        let text = this.add.text(centerX, centerY, 'Computer Wins!');
...
class ModalText2 extends Phaser.Scene {
    ...
    create (data)
    {
        ...
        const centerX = 0.5 * width;
        const centerY = 0.5 * height;
        let text = this.add.text(centerX, centerY, 'Player 1');
        text.x = text.x - text.displayWidth*0.5;
        this.scene.bringToTop();
