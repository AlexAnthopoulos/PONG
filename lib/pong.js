...
class PongScene
{
    ...
    create ()
    {
        ...
        this.players = [];
        // Placeholder texture (__missing)
        this.players[0] = this.add.existing(new Player(this, 40, centerY, '__missing'));
        this.players[1] = this.add.existing(new Player(this, width - 40, centerY, '__missing'));
        this.ball = this.add.existing(new Ball(this, centerX, centerY, '__missing'));
